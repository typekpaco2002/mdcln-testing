...
**Generated at:** 2026-05-17T21:40:43.121Z

## Hooks (16)

- `client/src/hooks/useActiveGeneration.js`
- `client/src/hooks/useBranding.js`
- `client/src/hooks/useCachedModels.js`
- `client/src/hooks/useDraft.js`
- `client/src/hooks/useGenerationHistory.js`
- `client/src/hooks/useGenerations.js`
- `client/src/hooks/useModels.js`
- `client/src/hooks/useNsfwGallery.js`
- `client/src/hooks/usePageVisibility.js`
- `client/src/hooks/usePrivateMode.js`
- `client/src/hooks/useReducedMotion.js`
- `client/src/hooks/useTelegram.js`
- `client/src/hooks/useTelegramBackButton.js`
- `client/src/hooks/useTelegramMainButton.js`
- `client/src/hooks/useTheme.jsx`
- `client/src/hooks/useTutorialCatalog.js`

## Flows Studio node components (24)
