...
const COPY = {
  en: {
    ...
    heroCreateStudioTitle: "Create Content",
    heroCreateStudioBody:
      "Use our creator studio to create cinema grade content.",
    heroCreateAvatarTitle: "Create Content with Avatar",
    heroCreateAvatarBody:
      "Create personalised content with your AI avatar.",
  },
  ru: {
    ...
    mobileNavReformatter: "Конвертер",
    mobileNavFirstFrame: "Первый кадр",
    ...
    mobileTelegram: "Telegram",
    mobileDiscord: "Discord",
    mobilePrivateModeOn: "Приватный режим включён",
    ...
    premiumGateDescription:
      "Оформите подписку для доступа к премиум-возможностям: курсам, переработке фото/видео и поиску рилс.",
    premiumGateViewPlans: "Тарифы подписки",
    premiumGateMaybeLater: "Позже",
    earnModalTitle: "Зарабатывайте с вашей ИИ-моделью",
    earnModalBody1:
      "Монетизируйте ИИ-контент на Fanvue — платформе, где можно размещать ИИ-модели и продавать их контент.",
    earnModalBody2:
      "ИИ-модели официально разрешены! Сохраняйте 100% дохода — без проблем с реальными моделями.",
    earnModalChipKeepProfits: "Вся прибыль ваш",
    earnModalChipNoRealModels: "Без реальных моделей",
    earnModalChipEarn247: "Заработок 24/7",
    earnModalCta: "Начать на Fanvue",
    earnModalDiscordText: "Узнайте, как продвигать ИИ-модель бесплатно",
    earnModalDiscordCta: "Вступить в Discord ModelClone",
    referralModalTitle: "Реферальная программа",
    referralModalSubtitle: "15% с первой покупки каждого приведённого пользователя",
    referralModalHowItWorks: "Как это работает",
    referralModalStep1: "Создайте уникальную реферальную ссылку",
    referralModalStep2: "Делитесь ею и приводите пользователей",
    referralModalStep3: "Запросите выплату, когда накопится $100+ вознаграждения",
    referralModalCta: "Открыть реферальную программу",
    referralModalChipCommission: "15% комиссия с первой покупки",
    referralModalChipPayouts: "Ручные выплаты через администратора",
    referralModalChipUnlimited: "Без ограничения по рефералам",
    whatsNewTitle: "NSFW-студия запущена",
    whatsNewSubtitle: "Для всех авторов",
    whatsNewFeatureTitle: "NSFW-студия",
    whatsNewFeatureBody:
      "Контент 18+ с вашими ИИ-моделями. Обучайте собственный LoRA и генерируйте изображения с заменой лица.",
    whatsNewNote:
      "Раздел NSFW в боковой панели или /nsfw. Доступ — только для моделей по правилам продукта.",
    whatsNewCta: "Перейти в NSFW-студию",
    whatsNewMaybeLater: "Позже",
    homeWelcomeBack: "С возвращением,",
    homeFallbackCreator: "Автор",
    homeSubtitle: "Центр вашего ИИ-контента",
    statsCredits: "Кредиты",
    statsAddCredits: "Пополнить кредиты",
    statsImages: "Изображения",
    statsVideos: "Видео",
    statsThisMonth: "за месяц",
    mainCreateModelTitle: "Создать ИИ-аватар",
    mainCreateModelBody: "Имя, параметры и 3 фотографии",
    mainUploadRealTitle: "Клон реального человека",
    mainUploadRealBody: "Фото реального человека для обучения",
    tutorialTitle: "Краткое обучение",
    ...
    quickStartEarningTitle: "Монетизация",
    quickStartEarningBody: "Продавайте контент на Fanvue",
    quickLearnMore: "Подробнее",
    quickAffiliateTitle: "Партнёрская программа",
    quickAffiliateBody: "15% комиссии с первой покупки каждого реферала",
    ctaReadyTitle: "Готовы к созданию?",
    ctaReadyBody: "Генерация качественных ИИ-изображений и видео",
    ctaStartGenerating: "Запуск генерации",
    purchaseTierFallback: "Ваш план",
    heroCreateStudioTitle: "Создавайте контент",
    heroCreateStudioBody:
      "Студия автора — для выпуска кинематографичного контента.",
    heroCreateAvatarTitle: "Контент с аватаром",
    heroCreateAvatarBody:
      "Персонализированный контент с вашим ИИ-аватаром.",
  },
};
